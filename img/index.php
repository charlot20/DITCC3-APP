...
<head>
    ...
    <title>CharlotMaramag Resume</title>
...
<body id="page-top">
    ...
    ======================================================-->
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div class="my-auto" >
              <img src="img/logo-ss.png" class="img-fluid mb-3" alt="">
              <h1 class="mb-0">Charlot
                <span class="text-primary">Maramag</span>
              </h1>
              <div class="subheading mb-5">STUDENT | INSTRUCTOR | DESIGNER
              
              </div>
              <p class="mb-5" style="max-width: 500px;" ></p>
              ...
              <div class="resume-item col-md-6 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-globe mr-3 text-info"></i> College Instructor</h4>
                      <p>7+ years of experience as University Instructor. Achieved the post of IT Faculty/Instructor in an institution that offers me to use my technical as well as intellectual abilities to contribute towards the institutional goals in consonance with its vision and mission while being resourceful and innovative.</p>
                  </div>
    ...
    ======================================================-->      
      <section  id="portfolio"> 
              ...
              <div class="col-12">
                ...
                <img src="img/portfolio/p-6.jpg" width="400" height="300">
               </div>
              </div class="col-12">
              <img src="img/portfolio/p-7.jpg" width="400" height="300">
             </div>
            </div class="col-12">
            <img src="img/portfolio/p-8.jpg" width="400" height="300">
           </div>
          </div>
              </section>>
            ...
            <div class="col-md-4 col-sm-12 mt-5"> 
              <div class="contact-cont2"> 
                <div class="contact-add contact-box-desc">
                  ...
                  <p>145, Mabini St., Gonzaga <br>
                  Philippines, 3513 <br></p>
                </div>
                ...
                <address class="address-details-f"> 
                  Fax: (078) 377 7584 <br>
                  Email: <a href="mailto:info@themsbit.com" class="">charlotmaramag@csu.edu.ph</a>
                </address>
